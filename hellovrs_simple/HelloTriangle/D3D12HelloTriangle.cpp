...
void D3D12HelloTriangle::LoadPipeline()
{
	...
	m_additionalRatesSupported = false;
	if (SUCCEEDED(m_device->CheckFeatureSupport(D3D12_FEATURE_D3D12_OPTIONS6, &options6, sizeof(options6))))
	{
		m_additionalRatesSupported = !!options6.AdditionalShadingRatesSupported;
...
void D3D12HelloTriangle::OnKeyUp(UINT8 key)
{
	...
	UINT allowedShadingRateCount = m_additionalRatesSupported ? 7 : 4;

	if (key == 37 && m_shadingRateIndex > 0) // left
	{
		m_shadingRateIndex--;
	}
	if (key == 39 && m_shadingRateIndex < allowedShadingRateCount - 1) // right
	{
		m_shadingRateIndex++;
	}
...
void D3D12HelloTriangle::UpdateTitleText()
{
	...
	if (m_platformSupportsVRS)
	{
		...
		{
		case 0: titleText = L"1x1"; break;
		case 1: titleText = L"1x2"; break;
		case 2: titleText = L"2x1"; break;
		case 3: titleText = L"2x2"; break;
		case 4: titleText = L"2x4"; break;
		case 5: titleText = L"4x2"; break;
		case 6: titleText = L"4x4"; break;
		}
	}
	else
	{
